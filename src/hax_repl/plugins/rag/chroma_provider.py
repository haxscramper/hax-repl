...
class ChromaVectorRagProvider(RagProvider):
    ...
    def __init__(self) -> None:
        ...
        model = os.getenv("HAX_REPL_EMBEDDING_MODEL",
                          DEFAULT_EMBEDDING_MODEL).strip()
        if "/" not in model:
    ...
    def query(self,
        ...
        for idx, doc in enumerate(documents):
            ...
            chunks.append(
                RagChunk(source_id=source_id, text=str(doc), score=score))
